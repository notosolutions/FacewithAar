package com.app.facerecogn.common;
...
import com.app.facerecogn.common.preference.PreferenceUtils;
...
public class Camerasource {
  ...
  public void takeByteArrayofPicture(ShutterCallback shutter, PictureCallback jpeg) {
    synchronized (processorLock) {
      if (camera != null) {
